        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">
                        Silahkan kelola reviewer movie.
                    </p>
                    <?php
...
// echo $curl;
                    ...
                    <!-- Card Example -->
                    <a href="movie/tambah_movie.php" class="btn btn-primary mb-4" type="button" data-toggle="modal"
                        data-target="#tambahModal" name="tambah_pengguna_btn">Tambah
                        Buku</a>
                                ...
                                <div class="card h-100">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <a href="" class="btn btn-success btn-sm" type="button" data-toggle="modal"
                                            ...
                                            <a href="" class="btn btn-danger btn-sm" type="button" data-toggle="modal"
                                                data-target="#deleteModal<?= $row['id'] ?>" name="delete_btn">Delete</a>
                                            <a href="" class="btn btn-warning btn-sm" type="button" data-toggle="modal"
                                                data-target="#reviewModal<?= $row['id'] ?>" name="review_btn">Review</a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="movie/edit_movie.php" method="POST" class="user">
                                                    <div class="form-group">
                                                        <input type="hidden" name="id" value="<?= $row['id'] ?>" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="id">Id Movie:</label>
                                                        <input type="text" class="form-control form-control-user"
                                                            aria-describedby="emailHelp" placeholder="Id" name="id"
                                                            value="<?= $row['id'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-user"
                                                            aria-describedby="emailHelp" placeholder="Actors" name="actors"
                                                            value="<?= $row['actors'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="sutradara">Sutradara:</label>
                                                        <input type="text" class="form-control form-control-user"
                                                            aria-describedby="emailHelp" placeholder="Sutradara"
                                                            name="sutradara" value="<?= $row['sutradara'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="genre">Genre:</label>
                                                        <input type="text" class="form-control form-control-user"
                                                            aria-describedby="emailHelp" placeholder="Genre" name="genre"
                                                            value="<?= $row['genre'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="image">Image:</label>
                                                        <input type="text" class="form-control form-control-user"
                                                            aria-describedby="emailHelp" placeholder="Image" name="image"
                                                            value="<?= $row['image'] ?>">
                                                    </div>
                                ...
                                <div class="modal fade" id="deleteModal<?= $row['id'] ?>" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="movie/delete_movie.php" method="POST" class="user">
                                                    <div class="form-group">
                                                        <input type="hidden" name="id" value="<?= $row['id'] ?>" />
                                                    </div>
                                                    <div class="form-group">
                                ...
                                <div class="modal fade" id="reviewModal<?= $row['id'] ?>" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="review_movie.php" method="POST" class="user">
                                                    <div class="form-group">
                                                        <input type="hidden" name="id" value="<?= $row['id'] ?>" />
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <button type="submit" class="btn btn-warning" name="review_btn">Lihat
                                                        Review</button>
                                                </form>
    ...
    <div class="modal fade" id="tambahModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Movie</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="movie/tambah_movie.php" method="POST" class="user">
                        <div class="form-group">
                            <label for="title">Title:</label>
                        ...
                        <div class="form-group">
                            <label for="publisher">Actors:</label>
