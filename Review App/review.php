        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">
                        Silahkan kelola review buku.
                    </p>
                    <?php
                    function getData($url, $token, $getData)
                    {
                        $curl = curl_init();

                        // Set URL with the book id
                        $url = $url . '/?book_id=' . $getData['id'];
                    ...
                    $curl = getData($url, $token, $getData);
                    ...
                    <div class="row row-cols-1 row-cols-md-4 ">
                        ...
                        foreach ($output['data'] as $row) {
                            ...
                            <div class="col mb-4">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <h5 class="card-title">ID Reviewer:
                                            <?= $row['reviewer_id'] ?>
                                        </h5>
                                        ...
                                        <p class="card-text"><strong>ID book:</strong>
                                            <?= $row['book_id'] ?>
                                        </p>
                                        <p class="card-text"><small class="text-muted"><strong>created at </strong>
                                                <?= $row['created_at'] ?>
                                            </small></p>
                                    </div>
                                </div>
                                ...
                                <div class="modal fade" id="deleteModal<?= $row['id'] ?>" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Lihat Review</h5>
                                                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">×</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="card text-bg-warning mb-3" style="max-width: 18rem;">
                                                    ...
                                                    <div class="card-body">
                                                        <h5 class="card-title"><strong>Comment:</strong>
                                                            <?= $row['comment'] ?>
                                                        </h5>
                                                        <h5 class="card-title"><strong>Id Reviews:</strong>
                                                            <?= $row['comment'] ?>
                                                        </h5>
                                                        <h5 class="card-title"><strong>Rating:</strong>
                                                            <?= $row['rating'] ?>
                                                        </h5>
                                                        <h5 class="card-title"><strong>Book Id:</strong>
                                                            <?= $row['book_id'] ?>
                                                        </h5>
                                                        <h5 class="card-title"><strong>Reviewer Id:</strong>
                                                            <?= $row['reviewer_id'] ?>
                                                        </h5>
                                                        <p class="card-text"></p>
                                                    </div>
    ...
    <div class="modal fade" id="tambahModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="book/tambah_reviewer.php" method="POST" class="user">
                        <div class="form-group">
