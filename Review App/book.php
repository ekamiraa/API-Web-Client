...
// echo $curl;
                    ...
                    <!-- Card Example -->
                    <a href="book/tambah_book.php" class="btn btn-primary mb-4" type="button" data-toggle="modal"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="book/edit_book.php" method="POST" class="user">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-user"
                                                            aria-describedby="emailHelp" placeholder="Publisher"
                                                            name="publisher" value="<?= $row['publisher'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="author">Author:</label>
                                                        <input type="text" class="form-control form-control-user"
                                                            aria-describedby="emailHelp" placeholder="Author" name="author"
                                                            value="<?= $row['author'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                ...
                                <div class="modal fade" id="deleteModal<?= $row['id'] ?>" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="book/delete_book.php" method="POST" class="user">
                                                    <div class="form-group">
                                                        <input type="hidden" name="id" value="<?= $row['id'] ?>" />
                                                    </div>
                                                    <div class="form-group">
                                ...
                                <div class="modal fade" id="reviewModal<?= $row['id'] ?>" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="review.php" method="POST" class="user">
                                                    <div class="form-group">
                                                        <input type="hidden" name="id" value="<?= $row['id'] ?>" />
                                                    </div>
                                                    <div class="form-group">
    ...
    <div class="modal fade" id="tambahModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="book/tambah_buku.php" method="POST" class="user">
                        <div class="form-group">
